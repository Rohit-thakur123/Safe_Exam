...
function App() {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      combined.push(`Exit code: ${payload.exitCode}`);
      combined.push(`Time: ${payload.executionTimeMs}ms`);
      combined.push(`Memory limit: ${payload.memoryUsageBytes} bytes`);
